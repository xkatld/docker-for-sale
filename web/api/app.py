...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URI', 'sqlite:///containers.db')
    ...
    try:
        ...
        if container:
            ...
            try:
                ...
                logger.warning(f"Docker 容器 {container_id} 不存在，可能已被删除")
